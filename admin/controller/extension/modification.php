...
class ControllerExtensionModification extends Controller {
	...
	public function index() {
		...
		$this->model_extension_modification->install();
	...
	protected function getList() {
		...
		if ($import_files && count($import_files)) {
			$data['import_url'] = $this->url->link('extension/modification/import', 'token=' . $this->session->data['token'], true);
		}
	...
	public function import() {
		...
		$this->response->redirect($this->url->link('extension/modification', 'token=' . $this->session->data['token'] . $url));
	}
