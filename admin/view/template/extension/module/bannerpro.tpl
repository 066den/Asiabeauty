      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-sm-7">
                <label class="col-sm-7 control-label" for="input-mobile-image"><?php echo $entry_mobile; ?></label>
                <div class="col-sm-5">
              ...
              <div class="col-sm-5">
                <label class="col-sm-7 control-label" for="input-hide-text"><?php echo $entry_hide_text; ?></label>
                <div class="col-sm-5">
