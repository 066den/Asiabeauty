        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <fieldset>
            ...
            <?php $module_row = 0; ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="module-full-content" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-full-content').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-full-content').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>