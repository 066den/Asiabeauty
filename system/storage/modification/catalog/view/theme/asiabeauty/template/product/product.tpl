...
<div class="product-label product-page-labels">
  <?php if( $sold == 0 && $labels_sold_status == 1) {   ?>
        ...
        <?php if( $special )  { ?>
            ...
            <div class="product-label-sale"><span><?php echo $percent; ?>% <?php echo $labels_sale_text; ?></span></div>
            <?php } else { ?>            
            <div class="product-label-sale"><span><?php echo $labels_sale_text; ?></span></div>
            <?php } ?> 
        <?php } ?>
   <?php } else if( $sold == 1 && $labels_sold_status == 1)  { ?>
      <div class="product-label-sold"><span><?php echo $labels_sold_text; ?></div>
    <?php } else { ?>
      <?php if( $is_new < $labels_new) {   ?>            
        <div class="product-label-new"><span><?php echo $labels_new_text; ?></span></div>                                             
        <?php } ?>
